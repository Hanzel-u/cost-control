...
namespace ControlDeCredito.Controllers
{
    public class SexoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CodigoDeSexo,DescripcionDeSexo")] Sexo sexo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CodigoDeSexo,DescripcionDeSexo")] Sexo sexo)
        {
            if (ModelState.IsValid)
            {
